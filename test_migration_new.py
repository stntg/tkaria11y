...
class TestApp:
    def __init__(self):
        ...
        # TTK widgets
        self.ttk_button = AccessibleTTKButton(
            self.root, accessible_name="TTK Button", text="TTK Button"
        )
        ...
        if ctk:
            self.ctk_button = AccessibleCTKButton(
                self.root, accessible_name="CTK Button", text="CTK Button"
            )
