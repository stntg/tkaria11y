            ...
            if widget not in self._original_properties:
                ...
                try:
                    if hasattr(widget, 'cget'):
                        self._original_properties[widget]['border_width'] = widget.cget('border_width')
                        self._original_properties[widget]['border_color'] = widget.cget('border_color')
                except:
                    pass
            ...
            try:
                ...
                if hasattr(self._current_widget, 'configure'):
                    ...
                    if 'border_width' in original:
                        self._current_widget.configure(border_width=original['border_width'])
                    if 'border_color' in original:
                        self._current_widget.configure(border_color=original['border_color'])
...
class CTKFocusManager:
    ...
    def register_widget(self, widget: tk.Misc, focus_group: Optional[str] = None) -> None:
