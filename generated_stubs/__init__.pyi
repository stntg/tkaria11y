...
def configure_advanced_focus_traversal(root: Tk, widgets: Optional = ...) -> FocusManager: ...
...
class FocusManager:
    ...
    def register_widget(self: Any, widget: Widget, focus_group: Optional = ..., skip_focus: bool = ...) -> None: ...
    def remove_focus_callback(self: Any, widget: Widget, callback: Callable) -> None: ...
...
def validate_accessibility(root: Tk, compliance_level: ValidationLevel = ...) -> Dict: ...
...
class BrailleManager:
    ...
    def set_cursor_settings(self: Any, show: bool = ..., blink: bool = ..., rate: float = ...) -> None: ...
...
def setup_audio_accessibility(root: Tk, enable_spatial: bool = ..., master_volume: float = ..., cue_volume: float = ...) -> None: ...
...
class AudioCue:
    ...
    def __init__(self: Any, cue_type: AudioCueType, frequency: float, duration: float, volume: float, pattern: str = ..., spatial_position: Optional = ...) -> None: ...
...
class AudioAccessibilityManager:
    ...
    def play_cue_for_widget(self: Any, widget: Widget, cue_type: AudioCueType) -> None: ...
    ...
    def remove_audio_callback(self: Any, event_type: str, callback: Callable) -> None: ...
...
def validate_widget_accessibility(widget: Widget) -> List: ...

def enhance_widget_accessibility(widget: Widget, accessible_name: Optional = ..., accessible_description: Optional = ..., accessible_role: Optional = ...) -> None: ...

def create_accessible_widget(widget_type: str, master: Any = ..., kwargs: Any) -> Widget: ...

def discover_widgets(root: Widget) -> List: ...

def enhance_existing_widgets(root: Widget) -> None: ...
...
def setup_full_accessibility(root: Any, high_contrast: Any = ..., dyslexic_font: Any = ..., large_text: Any = ..., auto_fix: Any = ..., enable_audio: Any = ..., enable_braille: Any = ..., enable_spatial_audio: Any = ...) -> Any: ...

def quick_accessibility_audit(root: Any) -> Any: ...
